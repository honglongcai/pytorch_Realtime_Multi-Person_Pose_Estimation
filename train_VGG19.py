...
parser.add_argument('--mask_dir', default='training/dataset/COCO/', type=str, metavar='DIR',
                    help='path to where coco images stored')    
parser.add_argument('--logdir', default='training/vgg/tensorboy', type=str, metavar='DIR',
...
lr_scheduler = ReduceLROnPlateau(optimizer, mode='min', factor=0.8, patience=3, verbose=True, threshold=0.0001, threshold_mode='rel', cooldown=1, min_lr=0, eps=1e-08)
